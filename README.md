...
We used "Xception bottleneck features" for transfer learning to create a CNN that can identify dog breed from images. Our CNN must attained 84.5694% accuracy on the test set.
